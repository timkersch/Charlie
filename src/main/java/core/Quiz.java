...
public class Quiz {
     ...
     * @return a Map of questions and answers if user has answered questions,
     * otherwise null
     */
    ...
    /**
     * Returns the the player with the specified user id.
     * @param id the UserIdentity
     * @return an the player object
     */
    public Player getPlayer(UserIdentity id) {
        for (Player p : players) {
            if (p.getUserIdentity().equals(id)) {
                return p;
            }
