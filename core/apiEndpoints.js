...
module.exports = function(Quiz) {
    ...
    router.get('/api/getCurrentQuestion', middleware.ensureAuthenticated, middleware.inQuiz, function (req, res) {
    ...
    router.get('/api/getResults', middleware.ensureAuthenticated, middleware.inQuiz, function (req, res) {
        const quizID = req.session.quizID;
    ...
    router.get('/api/getCurrentQuiz', middleware.ensureAuthenticated, middleware.inQuiz, function (req, res) {
        const quizID = req.session.quizID;
